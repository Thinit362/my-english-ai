...
const u1: UnitPronunciation = {
  ...
  pronunciation: {
    ...
    focus: "Luyện phát âm ba cụm phụ âm đầu từ: /tr/, /kr/ và /br/.",
    viExplain: `Trong tiếng Anh, consonant clusters là những cụm gồm hai hoặc nhiều phụ âm đứng liền nhau mà không có nguyên âm xen giữa. Chúng có thể đứng ở đầu, giữa hoặc cuối từ.

Trong Unit 1, các em sẽ luyện ba cụm phụ âm rất hay gặp là /tr/, /kr/ và /br/.`,
    tips: [
      "Không thêm nguyên âm thừa giữa hai phụ âm (ví dụ *tər* thay cho /tr/).",
      "Luyện chậm từng âm đơn (/t/, /k/, /b/, /r/) rồi ghép lại.",
      "Nghe mẫu nhiều lần, bắt chước khẩu hình và ngữ điệu tự nhiên.",
    ],
    sounds: [
      // ====== ÂM /tr/ – PAGE 1 ======
      {
...
Khi ghép từ âm /t/ sang âm /r/, chúng ta sẽ được âm /tr/.`,
        image: "/images/pronunciation/u1-tr.png", // bạn đổi thành đường dẫn thật nếu có
        items: [
          // Các từ ví dụ
